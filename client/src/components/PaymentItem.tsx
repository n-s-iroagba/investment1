...
export function PaymentItem({
  ...
  return (
    <div className="bg-green-50 border-2 border-green-100 rounded-xl p-6 hover:border-green-200 transition-all">
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        ...
        <div className="flex-1 space-y-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
            <div>
              <p className="text-green-600 font-medium">Payment ID</p>
              <p className="text-green-900 font-mono">{payment.paymentID}</p>
            </div>
            
            <div>
              <p className="text-green-600 font-medium">Deposit Type</p>
        ...
        <div className="flex flex-wrap gap-2 lg:flex-col lg:items-end">
          ...
          {!payment.isVerified && !isAdmin && (
            <button
              ...
              className="flex items-center gap-2 px-3 py-2 bg-green-50 text-green-700 border border-green-200 rounded-lg hover:bg-green-100 transition-all text-sm"
            >
