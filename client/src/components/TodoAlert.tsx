  ...
  return (
    <div className="relative group bg-green-900/10 rounded-lg border-2 border-green-800 backdrop-blur-sm transition-all hover:bg-green-900/20" onClick={()=>router.push(link)}>
      <div className="flex flex-col items-center gap-4"> {/* Changed from items-start to items-center */}
        ...
        <a
          href={link}
          className="inline-flex items-center gap-2 px-4 py-2 bg-green-100 text-green-900 rounded-md hover:bg-green-200 transition-colors self-center" /* Changed from self-start */
        >
      ...
      {/* Decorative Elements */}
      <div className="absolute inset-0 -z-10 bg-gradient-to-r from-green-50/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
