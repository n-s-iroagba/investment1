...
const ContactCard: React.FC<ContactCardProps> = ({ icon: Icon, children }) => {
  return (
    <div className="group bg-white/60 backdrop-blur-sm rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border border-blue-100 hover:border-blue-200 hover:scale-105">
      <div className="flex flex-col items-center text-center">
        <div className="w-20 h-20 bg-gradient-to-br from-blue-400 to-emerald-500 rounded-full flex items-center justify-center mb-6 shadow-lg group-hover:shadow-xl transition-all duration-300 group-hover:scale-110">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col items-center mb-16">
          <div className="text-center mb-8">
            <h2 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-blue-600 to-emerald-700 bg-clip-text text-transparent mb-4">
              We&apos;ll Be Happy To Hear From You.
            </h2>
            <div className="w-24 h-1 bg-gradient-to-r from-blue-400 to-emerald-500 rounded-full mx-auto mb-6"></div>
          </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          ...
          <ContactCard icon={EnvelopeIcon} title="Email Us">
            <div className="space-y-3">
              ...
              <p className="text-blue-600 font-semibold text-lg hover:text-blue-700 transition-colors cursor-pointer">
                {companySupportEmail}
              </p>
          ...
          <ContactCard icon={MapPinIcon} title="Visit Us">
            <div className="space-y-3">
              ...
              <div className="bg-blue-50 rounded-lg p-4 border border-blue-100">
                <p className="font-semibold text-blue-700 mb-2">Business Hours</p>
        ...
        <div className="text-center">
          <div className="bg-gradient-to-r from-blue-500 to-emerald-600 rounded-3xl p-8 shadow-xl">
