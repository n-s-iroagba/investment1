    ...
    <div ref={componentRef} className="mb-6">
      <div className="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-2">
          {/* Client Count Column */}
          <div className="py-12 px-8 text-center bg-gradient-to-br from-blue-500 to-blue-600 text-white">
          ...
          {/* Asset Count Column */}
          <div className="py-12 px-8 text-center bg-gradient-to-br from-green-500 to-green-600 text-white">
            <div className="transform hover:scale-105 transition-transform duration-300">
              <h2 className="text-5xl md:text-6xl font-extrabold mb-3 tracking-tight">
