...
const Information: React.FC<InformationProps> = ({ head, text, icon: Icon }) => {
  return (
    <div className="flex flex-col items-center text-center p-6 bg-white/50 backdrop-blur-sm rounded-2xl border border-green-100 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col items-center mb-16">
          <div className="text-center mb-8">
            <h2 className="text-5xl md:text-6xl font-bold bg-gradient-to-r from-green-600 to-emerald-700 bg-clip-text text-transparent mb-2">
              Unlock your
            </h2>
          ...
          <div className="w-24 h-1 bg-gradient-to-r from-green-400 to-emerald-500 rounded-full mb-6"></div>
