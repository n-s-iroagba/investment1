...
const OfficeMap: React.FC = () => {
  return (
    <div className="px-4 max-w-4xl mx-auto my-8">
      ...
      <div className="bg-white rounded-2xl shadow-sm border-2 border-blue-50 hover:border-blue-100 transition-all relative group overflow-hidden">
        ...
        {/* Header with Icon */}
        <div className="flex items-center gap-3 p-4 sm:p-5 border-b border-blue-100">
        ...
        <div className="p-1 sm:p-2">
          <iframe
            title="Google Map"
            className="w-full h-48 sm:h-64 md:h-72 rounded-xl border border-blue-100"
        ...
        {/* Footer with Address */}
        <div className="p-4 sm:p-5 text-center bg-blue-50">
