...
const Information: React.FC<InformationProps> = ({ head, text, icon: Icon }) => {
  return (
    <div className="bg-white rounded-2xl p-6 h-full shadow-lg border border-green-100 hover:shadow-xl hover:border-green-200 transition-all duration-300 group">
      <div className="flex flex-col items-center text-center space-y-4">
        <div className="p-3 bg-gradient-to-br from-green-100 to-emerald-100 rounded-full group-hover:from-green-200 group-hover:to-emerald-200 transition-all duration-300">
          <Icon className="w-8 h-8 text-green-600 group-hover:text-green-700 transition-colors duration-300" />
        </div>
  ...
  return (
    <div className="relative py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-gray-50 via-green-50 to-emerald-50 overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-10 right-10 w-64 h-64 bg-green-200 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-pulse"></div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-4 lg:order-2 order-1">
            <div className="relative group">
              <div className="absolute -inset-4 bg-gradient-to-r from-green-400 to-emerald-500 rounded-2xl blur-lg opacity-20 group-hover:opacity-30 transition-opacity duration-300"></div>
              <div className="relative bg-white rounded-2xl p-6 shadow-xl border border-green-100 transform hover:scale-105 transition-transform duration-300">
              <Image 
  src={padlock} 
  alt="Security" 
  width={400} 
...
/>
                <div className="w-full h-80 bg-gradient-to-br from-green-100 to-emerald-100 rounded-xl flex items-center justify-center relative overflow-hidden">
                  <div className="absolute inset-0 bg-gradient-to-br from-green-200/50 to-emerald-300/50"></div>
                  <div className="relative z-10 text-center">
                    <LockClosedIcon className="w-32 h-32 text-green-600 mx-auto mb-4" />
                    <ShieldCheckIcon className="w-8 h-8 text-emerald-500 absolute top-4 right-4 animate-pulse" />
                    <CheckBadgeIcon className="w-6 h-6 text-green-400 absolute bottom-4 left-4 animate-bounce" />
                    <p className="text-green-700 font-semibold text-lg">Bank-Level Security</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="mt-20 grid grid-cols-2 md:grid-cols-4 gap-8">
          <div className="text-center p-6 bg-white rounded-2xl shadow-lg border border-green-100 hover:shadow-xl transition-shadow duration-300">
            <LockClosedIcon className="w-12 h-12 text-green-600 mx-auto mb-3" />
