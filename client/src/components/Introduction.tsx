...
const Introduction: React.FC = () => {
  return (
    <div className="relative py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-green-50 via-white to-emerald-50 overflow-hidden">
      {/* Background decorative elements */}
      <div className="absolute inset-0">
        <div className="absolute top-0 left-0 w-48 sm:w-64 lg:w-72 h-48 sm:h-64 lg:h-72 bg-green-200 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-blob"></div>
    ...
    <div className="flex-col align-center">
              ...
              <div className="w-20 sm:w-24 h-1 bg-gradient-to-r from-green-500 to-emerald-500 mx-auto lg:mx-0 rounded-full mb-3 sm:mb-4"></div>
      ...
      <div className="relative max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className="relative group order-2 lg:order-1 mt-8 lg:mt-0">
            <div className="absolute -inset-2 sm:-inset-4 bg-gradient-to-r from-green-400 to-emerald-500 rounded-2xl blur-lg opacity-20 group-hover:opacity-30 transition-opacity duration-300"></div>
            <div className="relative bg-white rounded-2xl p-4 sm:p-6 lg:p-8 shadow-xl border border-green-100 transform hover:scale-[1.02] transition-transform duration-300">
              <div className="w-full h-48 sm:h-64 lg:h-80 bg-gradient-to-br from-green-100 to-emerald-100 rounded-xl flex items-center justify-center relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-green-200/50 to-emerald-300/50"></div>
                <div className="relative z-10 text-center">
                  <TrophyIcon className="w-16 sm:w-20 lg:w-24 h-16 sm:h-20 lg:h-24 text-green-600 mx-auto mb-2 sm:mb-4" />
                  <SparklesIcon className="w-6 sm:w-8 h-6 sm:h-8 text-emerald-500 absolute top-2 sm:top-4 right-2 sm:right-4 animate-pulse" />
                  <ShieldCheckIcon className="w-5 sm:w-6 h-5 sm:h-6 text-green-400 absolute bottom-2 sm:bottom-4 left-2 sm:left-4 animate-bounce" />
                  <p className="text-green-700 font-semibold text-base sm:text-lg">Investment Success</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6 sm:space-y-8 order-1 lg:order-2">
            ...
            <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-lg border border-green-100 hover:shadow-xl transition-shadow duration-300">
              <div className="flex flex-col items-center text-center space-y-3 sm:space-y-4">
                <div className="p-3 sm:p-4 bg-gradient-to-br from-green-100 to-emerald-100 rounded-full">
                  <QuestionMarkCircleIcon className="w-6 sm:w-8 h-6 sm:h-8 text-green-600" />
                </div>
