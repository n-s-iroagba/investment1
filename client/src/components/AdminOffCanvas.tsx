  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      <button
        ...
        className="lg:hidden fixed top-2 left-2 z-50 p-2 rounded-lg bg-green-100 border border-green-900 text-green-900 shadow-lg hover:bg-green-200 transition-all"
      ...
      >
        <nav className="h-full overflow-y-auto p-3 lg:p-4 flex flex-col">
          ...
          <div className="mb-4 p-3 lg:p-4 border-b border-green-700">
            ...
            <h2 className="mt-2 text-center text-base lg:text-lg font-semibold text-green-100">Admin Dashboard</h2>
          </div>
