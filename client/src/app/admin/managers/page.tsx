...
export default function ManagerCrudPage() {
  ...
  <h1 className="text-2xl sm:text-3xl font-bold text-blue-900">Investment Managers</h1>
  <button
    name='addNewManager'
 ...
 { (!managers || managers.length === 0)? (
      ...
      <div className="bg-blue-50 p-8 rounded-2xl border-2 border-blue-100 text-center max-w-md mx-auto">
        ...
        <h3 className="text-lg font-semibold text-blue-900 mb-2">No Managers Yet</h3>
