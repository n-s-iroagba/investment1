...
class MailService {
    ...
    static async sendEmailVerificationMail(user, name) {
    ...
    static async resendEmailVerificationMail(user) {
        this.setupHandlebars();
        const mailOptions = {
            from: EMAIL_USER,
            to: user.email,
    ...
    static async sendForgotPasswordMail(user, token) {
    ...
    static async sendCustomEmail(to, subject, message, senderName = "Admin Team") {
        const mailOptions = {
